...
<script type="text/javascript">
    ...
    $(function() {
        ...
        function onchangeCombox(productType,yearVal){
            ...
            $.getJSON('${ctx}/productType/getMonInfoList?yearVal='+yearVal+'&productType='+productType+'&type=2', null, function (result) {
            ...
            //获取后台数据信息
            $.getJSON('${ctx}/productType/getDateList?yearVal='+yearVal+'&productType='+productType+'&type=2', null, function (result) {

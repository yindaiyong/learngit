        ...
        $(function() {
            ...
            $("#addDatePage").click(function () {
                parent.$.modalDialog({
                    ...
                    width : 1200,
                    height : 650,
                    href : '${ctx}/transactionDay/addBusinessOpenDayPage',
                    buttons : [ {
                        text : '提交',
                        iconCls : 'icon-save',
                        handler : function() {
            ...
            function addSubFun() {
                ...
                var opTypeVal = parent.$.modalDialog.handler.find('#filter_opType').combobox("getValue");
            ...
            $("#updateDatePage").click(function () {
                ...
                //获取当前所有的选中月份集合方法
                    ...
                    if(channelCode == "" || productCode == "" || opType == ""){
                        $.messager.show({
                            title : '提示',
                            msg : '选择需要更新交易开放时间的交易类型产品',
                            timeout : 1000
                        });
                        return
                    }
                    ...
                    if(monArray.length != 1){
                        ...
                        parent.$.modalDialog({
                            ...
                            '&channelName='+ aa+'&productName='+bb+'&type=2&opType='+opType,
                            buttons : [ {
                                text : '提交',
                                iconCls : 'icon-save',
                                handler : function() {
            ...
            function editSubFun() {
                ...
                var opTypeVal = parent.$.modalDialog.handler.find('#filter_opType').textbox("getValue");
                var toServer = parent.$.modalDialog.handler.find("#save_choose_date_dom").textbox("getValue");
                yearVal = yearVal.split("年")[0];
            ...
            $("#showDatePage").click(function () {
                ...
                var yearVal = $('#filter_cdYear').combobox("getValue");
                var opType = $('#filter_opType').combobox("getValue");
                var opTypeName = $('#filter_opType').combobox("getText");
                var channelName = $('#channelCode').combobox("getText");
                var productName = $("#productCode").combobox("getText");
                var aa=encodeURI(encodeURI(channelName));
                var bb=encodeURI(encodeURI(productName));
                ...
                if(monArray.length != 1){
                    ...
                    parent.$.modalDialog({
                        ...
                        '&productCode='+productCode+ '&yearVal='+yearVal+ '&monIndex='+checkMon+
                        '&channelName='+ aa+'&productName='+bb+'&type=1&opType='+opType,
                        buttons : [ {
                            text : '确认',
                            iconCls : 'icon-save',
                            handler : function() {
            ...
            $("#checkDateButton").click(function () {
                ...
                var channelName = $('#channelCode').combobox("getText");
                var productName = $("#productCode").combobox("getText");
                var opTypeVal = $("#filter_opType").combobox("getText")
            ...
            $("#deleteDateButton").click(function () {
                ...
                var channelName = $('#channelCode').combobox("getText");
                var productName = $("#productCode").combobox("getText");
                var opTypeVal = $('#filter_opType').combobox("getValue");
                var opTypeName = $('#filter_opType').combobox("getText");
                //获取当前多选框选中的月份数据
                //获取当前所有的选中月份集合方法
                var serialNos = $("input[name='monthCheck']:checked").map(function () {
                ...
                parent.$.messager.confirm("询问", "您确认删除"+"渠道编号《"+channelName+"》" +
                    "产品编号《"+productName+"》业务《"+opTypeName+"》年份《"+yearVal+"》"+serialNos+"月的数据吗？", function(b) {
                    if (b) {
            ...
            <tr>
                ...
                <td align="center">渠道:
                    ...
                    <input class="easyui-combobox"  style = "width:250px;"   id="productCode" name ="filter_productCode" data-options="
					     ...
					     "/>
                    业务:
                    <select id="filter_opType" name="filter_cdYear" style="width: 120px;"
...
<div data-options="region:'center',border:true,title:'产品交易日管理列表'">
    <div id="toolbar">

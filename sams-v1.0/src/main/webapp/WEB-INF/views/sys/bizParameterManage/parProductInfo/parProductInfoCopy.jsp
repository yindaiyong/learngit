...
<script type="text/javascript">
    ...
    $(function() {
    			         ...
    			         success :function(result){
    			             if(result.length !=0){
                                 ...
                                 for ( var i = 0; i <result.length; i++){
                                     if(result[i].AGENCYNO == zz){
                                         flag = true
									 }
                                 }
								$("#subChannelCombobox").combobox({
                                    url : '${ctx}/channelInfo/selectSubChannelList?channelCode='+code,
                                    editable : false,
                                    valueField:'AGENCYNO',
                                    ...
                                    onLoadSuccess:function(){
                                        if(flag){
                                            $('#subChannelCombobox').combobox("setValue",zz);
										}else{
                                            $('#subChannelCombobox').combobox("setValue",null);
										}
            ...
            onChange: function (newValue, oldValue) {
                ...
                $.ajax({
                    ...
                    success :function(data){
                        ...
                        /*  确认方式: */
                        var piProCfmWay = data.ptProCfmWay;
                        if (piProCfmWay == "1") {
        ...
        $('#editProduct').form({
            url : '${ctx}/parProductInfo/copySubmit',
            onSubmit : function() {
                progressLoad();
                //获取个人购买标志
				...
				<div title = "产品参数设置">
					...
					<table style="background-color : #E0ECFF;width:520px;">
						...
						<tr>
							...
							<tr>
								<td>子渠道信息：</td>
								<td rowspan="10" colspan="10"><input id="subChannelCombobox" style = "width:350px;" name="piSubChannelCode" class="easyui-combobox" />
									<input id="hidSub" style = "display:none" value="${entity.piSubChannelCode}" />
								</td>
							</tr>
					</table>

        ...
        $(function() {
         ...
         //查询渠道下产品信息、子渠道信息
           ...
           var curr_time = new Date();
            ...
            $('#addProduct').form({
                url : '${ctx}/productSalePrarms/addSubmit',
                onSubmit : function() {
                    progressLoad();
                    //获取个人购买参数
			...
			<table style="background-color : #E0ECFF ;width:520px;">
				<tr style="padding-bottom: 5px;">
						<td>渠道编号:<span style="color:red">*</span></td>
					     <td><input class="easyui-combobox"  style = "width:150px;" id="pspChannelCode"   name ="pspChannelCode" data-options="
					 ...
					 <td><input class="easyui-combobox"  style = "width:150px;"   id="pspChannelProductCode"   name ="pspChannelProductCode" value = "" data-options="
					     url:'${ctx}/combobox/queryUsedProductInfoComBox',
					     onBeforeLoad:function(param){
					        param.channelCode = '';
					     },
				...
				<tr>
						...
						<td><input class="easyui-combobox"  style = "width:150px;"   id="pspSubChannelCode"   name ="pspSubChannelCode" value = "" data-options="
					     url:'${ctx}/combobox/querySubChannelComBox',
					     onBeforeLoad:function(param){
					        param.channelCode = '';
					     },
					...
					<tr>
					    <td>支付币种:</td>
						<td><input id="pspCurrencyType" name="pspCurrencyType" class="easyui-combobox"  style = "width:140px;height:20px;" data-options="
					            url:' ${ctx}/sysDict/currencyGroup',
					            valueField:'dictCode',
					            textField:'dictName'"  required="required"/>
						</td>
						<td>缴款方式:</td>
						<td><input id="pspPayType" name="pspPayType" class="easyui-combobox" style = "width:140px;height:20px;" data-options="
				  ...
				  <tr>
					<td>个人购买:</td>
					<td><input type="radio" name="pspIndiBuyFlag" value="1" checked/>是
					         <input type="radio" name="pspIndiBuyFlag" value="0" />否
					</td>
					<td style="padding-left:52px;">机构购买:</td> 
					<td>
					    <input type="radio" name="pspInstBuyFlag" value="1" checked/>是
			...
			<div class="easyui-accordion" data-options="multiple:true" style="width:520px;background-color : #E0ECFF;border:none;margin-top: 10px">
				<div title = "个人参数设置">
					<table style="background-color : #E0ECFF;width:520px;">
						<tr style="padding-bottom: 5px;">
							<td>首次购买最低金额（元）:</td>
							<td><input id="pspIndiMinBidsAmt" name="pspIndiMinBidsAmt" class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2"/></td>
							<td style="padding-left:25px;">首次购买级差金额（元）:</td>
							<td><input id="pspIndiBidsDiffAmt" name="pspIndiBidsDiffAmt" class="easyui-numberbox" type="number" style="width:100px;" value="1"  data-options="min:1,precision:2"/></td>
						</tr>
						<tr style="padding-bottom: 5px;">
							<td>首次购买最高金额（元）:</td>
							<td><input id="pspIndiMaxBidsAmt" name="pspIndiMaxBidsAmt" class="easyui-numberbox" type="number" style="width:100px;" value="0" min="0" data-options="min:0,precision:2"/></td>
							<td style="padding-left:25px;">最高账面份额（份）:</td>
							<td><input id="pspIndiMaxVol" name="pspIndiMaxVol" class="easyui-numberbox" type="number" style="width:100px;" value="0" min="0" data-options="min:0"/></td>
						</tr>
						<tr style="padding-bottom: 5px;">
							<td>追加购买最低金额（元）:</td>
							<td><input id="pspIndiMinAppBidsAmt" name="pspIndiMinAppBidsAmt" class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2"/></td>
							<td style="padding-left:25px;">追加购买级差金额（元）:</td>
							<td><input id="pspIndiAppBidsDiffAmt" name="pspIndiAppBidsDiffAmt" class="easyui-numberbox" type="number" style="width:100px;" value="1" data-options="min:1,precision:2"/></td>
						</tr>
						<tr style="padding-bottom: 5px;">
							<td>追加购买最高金额（元）:</td>
							<td><input id="pspIndiMaxAppBidsAmt" name="pspIndiMaxAppBidsAmt" class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2"/></td>
						</tr>
						<!-- <tr style="padding-bottom: 5px;">
							<td>最低赎回份额（份）:</td>
							<td><input id="pspIndiMinRedeemVol" name="pspIndiMinRedeemVol" class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0"/></td>
							<td style="padding-left:25px;">赎回级差（份）:</td>
							<td><input id="pspIndiRedeemDiff" name="pspIndiRedeemDiff" class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:1"/></td>
						</tr><tr style="padding-bottom: 5px;">
							<td>最低账面份额（份）:</td>
							<td><input id="pspIndiMinVol" name="pspIndiMinVol" class="easyui-numberbox" type="number"  style="width:100px;" value="0" data-options="min:0"/></td>
						</tr> -->
					</table>
				</div>
				</div>
				...
				<div title = "机构参数设置">
					<table style="background-color : #E0ECFF;width:520px;">
						<tr style="padding-bottom: 5px;">
							<td>首次购买最低金额（元）:</td>
							<td><input id="pspInstMinBidsAmt" class="easyui-numberbox" name="pspInstMinBidsAmt" type="number" style="width:100px;" value="0" data-options="min:0,precision:2"/></td>
							<td style="padding-left:25px;">首次购买级差金额（元）:</td>
							<td><input id="pspInstBidsDiffAmt" name="pspInstBidsDiffAmt" class="easyui-numberbox" type="number" style="width:100px;" value="1" data-options="min:1,precision:2"/></td>
						</tr>
						<tr style="padding-bottom: 5px;">
							<td>首次购买最高金额（元）:</td>
							<td><input id="pspInstMaxBidsAmt" name="pspInstMaxBidsAmt" class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2"/></td>
							<td style="padding-left:25px;">最高账面份额（份）:</td>
							<td><input id="pspInstMaxVol" name="pspInstMaxVol" class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0"/></td>
						</tr>
						<tr style="padding-bottom: 5px;">
							<td>追加购买最低金额（元）:</td>
							<td><input id="pspInstMinAppBidsAmt" name="pspInstMinAppBidsAmt" class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2"/></td>
							<td style="padding-left:25px;">追加购买级差金额（元）:</td>
							<td><input id="pspInstAppBidsDiffAmt" name="pspInstAppBidsDiffAmt" class="easyui-numberbox" type="number" style="width:100px;" value="1" data-options="min:1,precision:2"/></td>
						</tr>
						<tr style="padding-bottom: 5px;">
							<td>追加购买最高金额（元）:</td>
							<td><input id="pspInstMaxAppBidsAmt" name="pspInstMaxAppBidsAmt" class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2"/></td>
						</tr>
						<!-- <tr style="padding-bottom: 5px;">
							<td>最低赎回份额（份）:</td>
							<td><input id="pspInstMinRedeemVol" name="pspInstMinRedeemVol" class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0"/></td>
							<td style="padding-left:25px;">赎回级差（份）:</td>
							<td><input id="pspInstRedeemDiff" name="pspInstRedeemDiff" class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:1"/></td>
						</tr><tr style="padding-bottom: 5px;">
							<td>最低账面份额（份）:</td>
							<td><input id="pspInstMinVol" name="pspInstMinVol" class="easyui-numberbox" type="number"  style="width:100px;" value="0" data-options="min:0"/></td>
						</tr> -->

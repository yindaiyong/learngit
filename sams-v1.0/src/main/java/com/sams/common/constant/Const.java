...
public class Const {
	...
	public static final String FUND_TYPE_A="A";//开放净值类
	...
	public static final String FUND_TYPE_456="4,5,6"; // 固收、T+N、封闭净值类
   ...
   public static final String CHANNELCODESHNS="TTTNETSHNS";
	 ...
	 * 可开放的产品类型
	 */
	public static final String OPEN_PRO_TYPE = "openTypeProType";
	
	/**
	 * 配置的运行到哪一步重做需要提示
	 */
	public static final String ALERT_STEP = "alertStep";
}

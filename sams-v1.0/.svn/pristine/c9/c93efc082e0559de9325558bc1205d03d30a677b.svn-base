			...
			<table style="margin: auto" cellspacing="15">
				<tr>
					...
					<td align="center">
						...
						<input id="chooseChannelName" name="chooseChannelCode"
							   style="width: 230px; height: 20px;" class="easyui-textbox">
						</input>
						年度:
						<input id="filter_cdYear" name="filter_cdYear" style="width: 150px; height: 20px;"
				...
				<tr>
					...
					<td align="center">
						...
						月度:
						<input id="filter_cdMonth" name="filter_cdYear" style="width: 150px; height: 20px;"
							   class="easyui-textbox">
						</input>
					</td>
				</tr>

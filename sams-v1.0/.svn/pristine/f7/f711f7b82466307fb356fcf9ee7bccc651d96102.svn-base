...
import com.sams.common.annotation.SysSeqHelper;
import com.sams.common.exception.SequenceAspectException;
import com.sams.common.utils.FormatUtils;
import com.sams.common.utils.StringUtils;
import com.sams.sys.mapper.SysSequenceMapper;
import com.sams.sys.model.SysSequence;
...
public class SequenceAspect  {
	 ...
	 * 切入点
	 */
	@Pointcut(" execution(* com.sams.*.mapper.**.insert*(..))")
	public void aspect(){}

			...
			<table style="background-color : #E0ECFF ;width:520px;">
				...
				<tr>
				 ...
				 <tr>	
				  ...
				  <tr>
					<td>个人购买:</td>
					<td><input type="radio" name="pspIndiBuyFlag" value="1"  disabled="disabled"/>是
					         <input type="radio" name="pspIndiBuyFlag" value="0"  disabled="disabled"/>否
					</td>
					<td style="padding-left:52px;">机构购买:</td> 
					<td>
					    <input type="radio" name="pspInstBuyFlag" value="1" disabled="disabled"/>是
					    <input type="radio" name="pspInstBuyFlag" value="0"  disabled="disabled"/>否
					</td>
				</tr>
			</table>
	    </div>
			...
			<div class="easyui-accordion" data-options="multiple:true" style="width:520px;background-color : #E0ECFF;border:none;margin-top: 10px">
				<div title = "个人参数设置">
					<table style="background-color : #E0ECFF;width:520px;">
						<tr style="padding-bottom: 5px;">
							<td>首次购买最低金额（元）:</td>
							<td><input id="pspIndiMinBidsAmt" name="pspIndiMinBidsAmt"  value = "${entity.pspIndiMinBidsAmt}"   class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2" disabled="disabled"/></td>
							<td style="padding-left:25px;">首次购买级差金额（元）:</td>
							<td><input id="pspIndiBidsDiffAmt" name="pspIndiBidsDiffAmt"  value = "${entity.pspIndiBidsDiffAmt}"  class="easyui-numberbox" type="number" style="width:100px;" value="0" min="0" data-options="min:0,precision:2"  disabled="disabled"/></td>
						</tr>
						<tr style="padding-bottom: 5px;">
							<td>首次购买最高金额（元）:</td>
							<td><input id="pspIndiMaxBidsAmt" name="pspIndiMaxBidsAmt"  value = "${entity.pspIndiMaxBidsAmt}"  class="easyui-numberbox" type="number" style="width:100px;" value="0" min="0" data-options="min:0,precision:2" disabled="disabled"/></td>
							<td style="padding-left:25px;">最高账面份额（份）:</td>
							<td><input id="pspIndiMaxVol" name="pspIndiMaxVol"  value = "${entity.pspIndiMaxVol}"  class="easyui-numberbox" type="number" style="width:100px;" value="0" min="0" data-options="min:0"  disabled="disabled"/></td>
						</tr>
						<tr style="padding-bottom: 5px;">
							<td>追加购买最低金额（元）:</td>
							<td><input id="pspIndiMinAppBidsAmt" name="pspIndiMinAppBidsAmt"  value = "${entity.pspIndiMinAppBidsAmt}"  class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2"  disabled="disabled"/></td>
							<td style="padding-left:25px;">追加购买级差金额（元）:</td>
							<td><input id="pspIndiAppBidsDiffAmt" name="pspIndiAppBidsDiffAmt"  value = "${entity.pspIndiAppBidsDiffAmt}"  class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2"  disabled="disabled"/></td>
						</tr>
						<tr style="padding-bottom: 5px;">
							<td>追加购买最高金额（元）:</td>
							<td><input id="pspIndiMaxAppBidsAmt" name="pspIndiMaxAppBidsAmt"  value = "${entity.pspIndiMaxAppBidsAmt}"   class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2"  disabled="disabled"/></td>
						</tr>
						<%-- <tr style="padding-bottom: 5px;">
							<td>最低赎回份额（份）:</td>
							<td><input id="pspIndiMinRedeemVol" name="pspIndiMinRedeemVol"  value = "${entity.pspIndiMinRedeemVol}"   class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0"  disabled="disabled"/></td>
							<td style="padding-left:25px;">赎回级差（份）:</td>
							<td><input id="pspIndiRedeemDiff" name="pspIndiRedeemDiff"  value = "${entity.pspIndiRedeemDiff}"  class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0" disabled="disabled"/></td>
						</tr><tr style="padding-bottom: 5px;">
							<td>最低账面份额（份）:</td>
							<td><input id="pspIndiMinVol" name="pspIndiMinVol"   value = "${entity.pspIndiMinVol}"  class="easyui-numberbox" type="number"  style="width:100px;" value="0" data-options="min:0" disabled="disabled"/></td>
						</tr> --%>
					</table>
				</div>
				</div>
				...
				<div title = "机构参数设置">
					<table style="background-color : #E0ECFF;width:520px;">
						<tr style="padding-bottom: 5px;">
							<td>首次购买最低金额（元）:</td>
							<td><input id="pspInstMinBidsAmt" class="easyui-numberbox" name="pspInstMinBidsAmt"   value = "${entity.pspInstMinBidsAmt}"  type="number" style="width:100px;" value="0" data-options="min:0,precision:2" disabled="disabled"/></td>
							<td style="padding-left:25px;">首次购买级差金额（元）:</td>
							<td><input id="pspInstBidsDiffAmt" name="pspInstBidsDiffAmt" class="easyui-numberbox"  value = "${entity.pspInstBidsDiffAmt}"  type="number" style="width:100px;" value="0" data-options="min:0,precision:2" disabled="disabled"/></td>
						</tr>
						<tr style="padding-bottom: 5px;">
							<td>首次购买最高金额（元）:</td>
							<td><input id="pspInstMaxBidsAmt" name="pspInstMaxBidsAmt" class="easyui-numberbox"  value = "${entity.pspInstMaxBidsAmt}"  type="number" style="width:100px;" value="0" data-options="min:0,precision:2" disabled="disabled"/></td>
							<td style="padding-left:25px;">最高账面份额（份）:</td>
							<td><input id="pspInstMaxVol" name="pspInstMaxVol" class="easyui-numberbox"  value = "${entity.pspInstMaxVol}"  type="number" style="width:100px;" value="0" data-options="min:0"  disabled="disabled"/></td>
						</tr>
						<tr style="padding-bottom: 5px;">
							<td>追加购买最低金额（元）:</td>
							<td><input id="pspInstMinAppBidsAmt" name="pspInstMinAppBidsAmt"  value = "${entity.pspInstMinAppBidsAmt}"  class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2" disabled="disabled"/></td>
							<td style="padding-left:25px;">追加购买级差金额（元）:</td>
							<td><input id="pspInstAppBidsDiffAmt" name="pspInstAppBidsDiffAmt"  value = "${entity.pspInstAppBidsDiffAmt}"  class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2" disabled="disabled"/></td>
						</tr>
						<tr style="padding-bottom: 5px;">
							<td>追加购买最高金额（元）:</td>
							<td><input id="pspInstMaxAppBidsAmt" name="pspInstMaxAppBidsAmt"  value = "${entity.pspInstMaxAppBidsAmt}"  class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0,precision:2" disabled="disabled"/></td>
						</tr>
						<%-- <tr style="padding-bottom: 5px;">
							<td>最低赎回份额（份）:</td>
							<td><input id="pspInstMinRedeemVol" name="pspInstMinRedeemVol"  value = "${entity.pspInstMinRedeemVol}" class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0" disabled="disabled"/></td>
							<td style="padding-left:25px;">赎回级差（份）:</td>
							<td><input id="pspInstRedeemDiff" name="pspInstRedeemDiff"  value = "${entity.pspInstRedeemDiff}"  class="easyui-numberbox" type="number" style="width:100px;" value="0" data-options="min:0" disabled="disabled"/></td>
						</tr><tr style="padding-bottom: 5px;">
							<td>最低账面份额（份）:</td>
							<td><input id="pspInstMinVol" name="pspInstMinVol"  value = "${entity.pspInstMinVol}"  class="easyui-numberbox" type="number"  style="width:100px;" value="0" data-options="min:0" disabled="disabled"/></td>
						</tr> --%>
					</table>
				</div>
			</div>

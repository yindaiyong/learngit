    ...
    <div class="gridDiv" data-options="region:'center',border:false">
        <form id="userAddForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>机构:<span style="color:red">*</span></td>
                ...
                <tr>
                    <td>地址:</td>
                    <td colspan="3"><input name="address" style="height:180px;" multiline="true" class="easyui-textbox" prompt="请输入地址信息"></input></td>
                </tr>
                <tr>
                	<td>描述:</td>
                    <td colspan="3"><input name="description" style="height:180px;" multiline="true" class="easyui-textbox" prompt="请输入描述信息"></input></td>
                </tr>
            </table>
        </form>
    </div>

    ...
    <div class="page-home">
        <el-container>
            <el-header height="100px">
                ...
                <div class="the-header-menu" style="pointer-events: none;">
                        ...
                        <div>
                            ...
                            <div class="card-item-body">
                                ...
                                :header-cell-style="{background:'transparent',color:'white',hover:'none'}">
                                    ...
                                    <el-table-column prop="status" width="120" label="生成状态"></el-table-column>
                                </el-table>
                            </div>
                        </div>
                    </el-carousel-item>
...
.page-home .the-header-menu .account-button-dropdown .el-menu.el-menu--horizontal{
    border-bottom: none;
}
...
.page-home .el-table__empty-text{
    color: white;
}
</style>